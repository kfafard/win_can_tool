...
- Integrate v1.2.28 release preparation into main (d24c8cd)
...
- Update changelog for v1.2.27 (1d014eb)

- Reconstruct release history through v1.2.27 and add Unreleased section (7e84a3c)

- Add standardized commit message guidelines (9c2f011)

- Document git-cliff commit convention and changelog workflow (f3c744f)

- Normalize structure before v1.2.28 release (320f458)
...
- Add standardized commit message template (4ad079a)
